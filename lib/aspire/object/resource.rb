    ...
    class Resource < Base
      ...
      def part_title_by_type(resource_type)
        if type == resource_type
          title
        elsif has_part && has_part.type == resource_type
          has_part.title
        end
      end
      ...
      def part_of_title_by_type(resource_type)
        if type == resource_type
          title
        elsif is_part_of && is_part_of.type == resource_type
          is_part_of.title
        end
      end
    end
